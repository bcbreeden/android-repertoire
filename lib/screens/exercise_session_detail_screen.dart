...
class ExerciseSessionDetailScreen extends StatefulWidget {
  final ExerciseSession session;
  final Exercise exercise;
  const ExerciseSessionDetailScreen({
    super.key,
  ...
  @override
  State<ExerciseSessionDetailScreen> createState() =>
      _ExerciseSessionDetailScreenState();
}

class _ExerciseSessionDetailScreenState
    extends State<ExerciseSessionDetailScreen> {
  ...
  void initState() {
    ...
    _minutesController = TextEditingController(
        text: s.durationSeconds != null
            ...
            : '');
    _bpmController =
        TextEditingController(text: s.bpm?.toString() ?? '');
  ...
  Future<void> _save() async {
    ...
    final updated = widget.session.copyWith(
      ...
      clearBpm: _bpmController.text.trim().isEmpty,
    ...
    await provider.updateExerciseSession(updated);
    if (!mounted) return;
  ...
  Future<void> _confirmDelete() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Delete this exercise session? This cannot be undone.',
    ...
    if (confirmed == true && mounted) {
      final provider = context.read<ExerciseProvider>();
      await provider.deleteExerciseSession(widget.session.id!);
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          if (widget.exercise.source != null) ...[
